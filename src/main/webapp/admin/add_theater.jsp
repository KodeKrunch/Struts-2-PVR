...
<h1>Enter Details</h1>
	<form action="${pageContext.request.contextPath}/admin/addsuccessfully" method="post">
			...
			<table id="table_id">
				<tr><td><s:select name="cityId" label="Select City" list="listOfCities" listKey="cityId" listValue="cityName"/>
				</td></tr>
				<td><a href="${pageContext.request.contextPath}/admin/addcity"> If Not In the List, Add City </a> </td>
				
				<tr><td><s:textfield key = "Theater Name" name = "theaterName"/><br></td></tr>
