...
<body bgcolor="#FFFFF0">
	...
	<div class="mainselection" > 
		<select name="movieDate" id="movieDate">
			  ...
			  <option value="2019-01-05">05/04/2019</option>
			  <option value="2019-01-06">06/04/2019</option>
			  <option value="2019-01-07">07/04/2019</option>
	...
	<br>
		<div id="nextstep">
		<center><button type="submit" ><b> Select Seat </button></center>
		</div>
	</form>
